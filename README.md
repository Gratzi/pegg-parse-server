...
* Copy `.env.example` to `.env` and put your keys and database information there.
* Run the server with: `DEBUG=pegg:* npm start`
...
Copy `dashboard-config.example.json` to `dashboard-config.json` and configure your apps.
